...
const LandingPage = ({ onComplete, theme, toggleTheme }) => {
  ...
  return (
    <div className={`h-full bg-coffee-900 text-coffee-100 flex flex-col items-center justify-start md:justify-center p-4 md:p-8 relative overflow-hidden transition-colors duration-500 ${theme}`}>
      ...
      <div className="z-10 w-full max-w-6xl overflow-y-auto overscroll-contain mt-16 md:mt-0">
        <div className="bg-coffee-800/50 backdrop-blur-xl border border-coffee-700/50 rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row h-auto md:h-[calc(100%-4rem)] md:max-h-[880px]">
